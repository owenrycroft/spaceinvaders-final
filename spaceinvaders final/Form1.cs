    ...
    public partial class Form1 : Form
    {
        ...
        private void mainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            foreach (Control x in this.Controls)
            {
                ...
                if(x is PictureBox&& (string)x.Tag=="sadInvaders")
                {
                    ...
                    {
                        gameOver("You have been invaded by the sad invaders, you lose");
                    }
                ...
                if(x is PictureBox && (string)x.Tag == "sadbullet")
                {
                    ...
                    {
                        this.Controls.Remove(x);
                        gameOver("youve been killed by the bullets .Now your dead ");
                    }
            ...
            {
                gameOver("you win we so porud of you ");
            }
        ...
        private void removeAll()
        {
            ...
            foreach(Control x in this.Controls)
            {
                if(x is PictureBox)
                {
                    if((string)x.Tag=="bullet"|| (string)x.Tag == "sabBullet")
                    {
                        this.Controls.Remove(x);
                    }
                }
